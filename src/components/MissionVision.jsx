...
//           >
//             We believe technology should solve real problems, create meaningful connections, and make the world better for everyone. Our mission is to build digital solutions that matter.
//           </motion.p>
//         </motion.div>
...
//               }}
//               className={`p-8 rounded-2xl ${principle.color} text-white relative overflow-hidden transition-all duration-300`}
//             >
...
//           transition={{ duration: 0.8 }}
//           viewport={{ once: true }}
//           className="max-w-5xl mx-auto bg-white/90 backdrop-blur-sm p-10 rounded-3xl shadow-2xl border border-gray-100"
//         >
...
//                 We envision a world where digital solutions bridge gaps, empower communities, and create opportunities for all. Where technology serves as an equalizing force that enhances human potential without compromising our values.
//               </p>
//               <motion.button
//                 whileHover={{ y: -3, boxShadow: "0 10px 25px -10px rgba(99, 102, 241, 0.5)" }}
//                 whileTap={{ scale: 0.98 }}
//                 className="px-8 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold rounded-lg shadow-md transition-all duration-300 hover:to-purple-700"
//               >
//                 Join Our Mission
//               </motion.button>
//             </motion.div>
...
//               viewport={{ once: true }}
//             >
//               <div className="absolute inset-0 bg-gradient-to-br from-blue-100 to-purple-100 rounded-2xl overflow-hidden">
...
//                     }}
//                     className="w-40 h-40 border-8 border-indigo-300/50 rounded-full"
//                   >
//                     <motion.div
//                       animate={{ 
//                         rotate: -360,
...
//                       }}
//                       className="w-full h-full border-8 border-purple-300/50 rounded-full"
//                     />
//                   </motion.div>
//                 </div>
//               </div>
