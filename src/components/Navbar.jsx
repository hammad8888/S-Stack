      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden lg:flex items-center space-x-1">
            ...
            {/* Phone Hotline - Desktop (purely visual) */}
            <div className="ml-4 flex items-center">

              <button 
               
                className="flex items-center space-x-2 px-3 py-3 rounded-full bg-blue-500 transition-colors"
              >
                <FiPhone className="text-white " />
              </button>
              <div className="text-left px-2">
                <div className="text-xs font-medium text-gray-600"> Hotline 24/7</div>
                <div className="text-sm font-semibold text-gray-800">+92 321 3018303</div>
              </div>
            </div>
          </div>
          ...
          {isOpen && (
            ...
            >
              <div className="space-y-1 px-4 py-3">
                ...
                {/* Phone Hotline - Mobile Expanded (purely visual) */}
                <div className="pt-2">
